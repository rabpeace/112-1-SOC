...
HD_PWD='C:/Users/user/Desktop/hw/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw1.tcl
