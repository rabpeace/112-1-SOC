...
HD_PWD='C:/Users/user/Desktop/hw/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hw1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hw1.tcl -notrace
